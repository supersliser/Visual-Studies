...
Overrall, the blade is very good at displaying a narrative concept within its own right. In a real use case, the weapon would likely see posing and usage to allow it to fulfil the prophecy of Chekov's Gun, however, this would also require features outside of the weapon itself. Thus for these purposes, the weapon is fine at displaying the capacity for a sword to convey a story.
